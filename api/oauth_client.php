 ...
 * oauth_client.php
 *
 * @(#) $Id: oauth_client.php,v 1.107 2014/05/21 06:43:41 mlemos Exp $
 *
 */
...
<class>
	...
	<version>@(#) $Id: oauth_client.php,v 1.107 2014/05/21 06:43:41 mlemos Exp $</version>
...
*/
	...
	var $oauth_user_agent = 'PHP-OAuth-API (http://www.phpclasses.org/oauth-api $Revision: 1.107 $)';
		...
		switch(intval($this->oauth_version))
		{
			...
			case 2:
				...
				if(strlen($this->oauth_username))
				{
					...
					return $this->ProcessToken(null, false);
				}
				if($this->debug)
